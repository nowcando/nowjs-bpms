...
export class TaskMemoryRepository<T extends Task = Task> implements TaskRepository<T> {
    ...
    public findTask(taskId: string): Promise<T> {
        throw new Error("Method not implemented.");
    }
    public updateTaskDueDate(taskId: string, dueDate: Date | null): Promise<T> {
        throw new Error("Method not implemented.");
    }
    public updateTaskFollowUpDate(taskId: string, followUpDate: Date | null): Promise<T> {
        throw new Error("Method not implemented.");
    }
    public updateTaskTags(taskId: string, tags: string | null): Promise<T> {
        throw new Error("Method not implemented.");
    }
    public updateTaskCategories(taskId: string, categories: string | null): Promise<T> {
        throw new Error("Method not implemented.");
    }
    public findTasks(...taskId: string[]): Promise<T[]> {
        throw new Error("Method not implemented.");
    }
